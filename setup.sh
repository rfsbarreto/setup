...
# Java jdk
wget --no-cookies --no-check-certificate --header "Cookie: gpw_e24=http%3A%2F%2Fwww.oracle.com" "http://download.oracle.com/otn-pub/java/jdk/7/jdk-7-linux-x64.tar.gz"
...
update-alternatives --install "/usr/bin/java" "java" "/usr/java/jdk1.7.0_45/jre/bin/bin/java" 1
